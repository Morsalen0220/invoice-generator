...
const MustangTemplate = forwardRef(({ data }, ref) => {
  ...
  return (
    <div ref={ref} className="bg-white a4-print-fix flex flex-col mx-auto relative text-[#231f20] font-sans overflow-hidden" style={{ width: '210mm', minHeight: '297mm', padding: '0', boxSizing: 'border-box' }}>
